...
Приложение разработано для удобства чтения Псалтири в электронном виде. Номер кафизмы определяется автоматически, исходя из текущей даты и номера читающего, перед кафизмой подставляются начальные молитвы и молитвы со списками поминаемых между частями кафизмы.
